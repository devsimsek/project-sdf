...
Hands-on guides for common SDF patterns.

| Tutorial | Description |
|---|---|
| [Building a REST API](rest-api.md) | JSON API with Spark ORM and proper HTTP status codes |
| [User Authentication](authentication.md) | Session-based login with guards and middleware |
